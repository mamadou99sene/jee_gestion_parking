...
/**
 * Servlet implementation class SuppressionPlace
 */
@WebServlet("/suppressionPlace")
public class SuppressionPlace extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SuppressionPlace() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getValue("id_gerant")!=null&&request.getParameter("id_place")!=null&&!request.getParameter("id_parking").isEmpty())
		{
			...
			new PlaceHome().delete(place);
			response.sendRedirect("/gestion_parking/voir_place");
		}
		else
		{
