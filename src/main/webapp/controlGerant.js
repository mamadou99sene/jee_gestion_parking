 ...
 */
 ...
 envoi.addEventListener('click',function(e)
 {
	...
	{
		  e.preventDefault();
          prenom_m.textContent="Saisissez son prenom";
	...
	{
		  e.preventDefault();
          nom_m.textContent="Saisissez son nom";
	...
	{
		  e.preventDefault();
          email_m.textContent="Saisissez son email";
	...
	if(parking.validity.valueMissing)
	{
		  e.preventDefault();
          parking.style.border="1px solid red";
	}
	if(horaire.validity.valueMissing)
	{
		  e.preventDefault();
          horaire.style.border="1px solid red";
	}
