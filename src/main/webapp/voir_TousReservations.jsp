...
<body>
       ...
       <table class="table table-bordered table-striped mt-5">
         ...
         <tbody>
               <%
                   ...
                   if(request.getAttribute("tous_reservations")!=null)
                   {
                	   ArrayList<Reservation> reservations=(ArrayList)request.getAttribute("tous_reservations");
    ...
    function valider() 
    {
    	return confirm("Voulez vous vraiment valider cette reservation en tant qu'admin ?");
    }
    function devalider() 
    {
    	return confirm("Voulez vous vraiment annuler la validation de cette reservation en tant qu'admin ?");
    }
    </script>
</body>
</html>