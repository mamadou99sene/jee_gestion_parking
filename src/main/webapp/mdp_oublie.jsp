...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                  <%
	                                ...
	                                %>
	                                <%
	                                    if(request.getAttribute("recuperation")!=null)
	                                    {
	                                    	String message=(String)request.getAttribute("recuperation");
	                                ...
	                                %>
                                    <form class="form-valide" action="mdp_oublie" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="login">Votre login <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="login" name="login" placeholder="Saisissez votre login" required>
                                                <span id="login_mq"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="email">Adresse e-mail <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
        ...
        <script type="text/javascript" src="control_mdpo.js"></script>
