                ...
                <div class="col-xl-6">
                    <div class="error-content">
                        <div class="card mb-0">
                            ...
                            <% 
                            if(request.getAttribute("demande")!=null)
                            {
                            	String demande=(String)request.getAttribute("demande");
                            	out.println("<h1 class='error-text text-primary'>"+demande+"</h1>");
                            }
                            %>
                                
                                <h4 class="mt-4"><i class="fa fa-thumbs-up text-danger"></i> Merci pour la confiance</h4>
                                <% 
	                            if(request.getAttribute("reservation_envoye")!=null)
	                            {
	                            	String message=(String)request.getAttribute("reservation_envoye");
                                ...
                                <form class="mt-5 mb-5">
                                    ...
                                    <div class="text-center mb-4 mt-4"><a href="accueil_Client" class="btn btn-primary">Retour</a>
                                    </div>
                                </form>
                                <div class="text-center">
                                    <p>Copyright © gestion parking by <a href="https://themeforest.net/user/digitalheaps">FREE PARK</a></p>
