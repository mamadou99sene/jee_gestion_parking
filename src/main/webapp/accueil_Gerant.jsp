...
<body>
   <div class="content-body">
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">Nombre de place</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">
                                    <%
	                                if(request.getAttribute("nombre_place")!=null)
	                                {
	                                	int nombre_place=(int)request.getAttribute("nombre_place");
	                                	out.println(nombre_place);
	                                }
                                %></h2>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Horaire</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">
                                     <%
	                                if(request.getAttribute("horaire")!=null)
	                                {
	                                	Horaire horaire=(Horaire)request.getAttribute("horaire");
	                                	String heure_debut=horaire.getHeuredebut();
	                                	String heure_fin=horaire.getHeurefin();
	                                	out.println(heure_debut+" "+heure_fin);
	                                }
                                  %>
                                    </h2>
                                    <p class="text-white mb-0"><%out.println(new Date().toGMTString().substring(0,17)); %></p>
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Reservations gérées</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">
                                     <%
                ...
                <h5 class="text-primary">Les clients ayant effectués les dernieres reservation validées par le gerant courant</h5>
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h5 class="mt-3 mb-1">
                                    <%
	                                if(request.getAttribute("clients_reservation_gerees")!=null)
	                                {
	                                	ArrayList<Reservation> dernieres=(ArrayList<Reservation>)request.getAttribute("clients_reservation_gerees");
